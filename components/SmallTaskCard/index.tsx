...
export default function SmallTaskCard(props: SmallTaskCardProps) {
  ...
  return (
    <div className="flex flex-col w-full rounded-xl bg-white dark:bg-[#1F2128] border-[1px] border-[#E8EDF2] dark:border-[#313442] p-5 mt-5">
      <p className="text-[14px] text-[#535362] dark:text-[#8A8A98] font-semibold">
        {title}
      </p>
      ...
      <div className="flex flex-row justify-between items-center mt-3">
        ...
        <p className="text-[12px] text-[#7E7E8F] dark:text-[#8B8B93] py-2 px-4 rounded-2xl bg-[#E8EDF2] dark:bg-[#313442] font-medium">
          {formatDate}
        </p>
      </div>
      <div className="mt-5">
        <div className="flex justify-between mb-1">
          <span
            className={`text-sm text-[#7E7E8F] dark:text-white ml-[${progress}%]`}
          >
            {`${progress}%`}
          </span>
        </div>
